...
export default function Jamais() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#EED6DE] relative">
        ...
        <TouchableOpacity onPress={()=> navigation.navigate('Jamaiss')}
              className="py-3 bg-[#DE1457] rounded-xl mt-3 ml-8 mr-8">
                <Text className="text-xl font-bold text-center text-white">
                  Je n’ai jamais vu mes règles
                </Text>
             </TouchableOpacity>
             <TouchableOpacity onPress={()=> navigation.navigate('Deja')}
              className="py-3 bg-[#DE1457] rounded-xl mt-3 ml-8 mr-8">
                <Text className="text-xl font-bold text-center text-white">
                J’ai déja vu mes règles
                </Text>
             </TouchableOpacity>
    </SafeAreaView>
  )
