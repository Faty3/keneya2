 ...
 const navigation = useNavigation();
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#EED6DE] relative">
        ...
        <View className="w-[380px] h-[120px] rounded-full bg-[#fff] mt-2 -ml-16">
        ...
        <View className="w-[380px] h-[100px] rounded-full bg-[#fff] mt-2 -ml-16">
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Bonjours")}>
